...
const translations = {
  en: { dir: 'ltr', sub: "Vehicle Report", back: "Back to Search", privacy: "Privacy", ad: "ADVERTISEMENT", market: "Market:", base: "Decoded by:", nhtsa: "NHTSA (USA)", wmi: "WMI (Basic Data)", pTitle: "Full History Report", pDesc: "Check for hidden damages and mileage rollbacks.", pBtn: "GET FULL REPORT", lTitle: "🔒 Technical Data Protected", lDesc: "European manufacturers restrict detailed specs in free databases. Unlock for full history.", unBtn: "UNLOCK CARVERTICAL REPORT", s: { gen: "General Info", eng: "Engine & Performance", saf: "Safety & Features" }, f: { make: "Make", model: "Model", year: "Year", trim: "Trim", type: "Vehicle Type", body: "Body", doors: "Doors", eng: "Engine", hp: "HP", fuel: "Fuel", drive: "Drive", trans: "Transmission", brk: "Brakes", abs: "ABS", tpms: "TPMS", cntry: "Country" }, footer: "© 2026 VIN DECODER" },
  uk: { dir: 'ltr', sub: "Звіт про авто", back: "Назад", privacy: "Політика конфіденційності", ad: "РЕКЛАМА", market: "Ринок:", base: "База:", nhtsa: "NHTSA (США)", wmi: "WMI (Базовий стандарт)", pTitle: "Повна історія авто", pDesc: "Перевірте скручений пробіг та історію ДТП.", pBtn: "ОТРИМАТИ ПОВНИЙ ЗВІТ", lTitle: "🔒 Технічні дані захищені", lDesc: "Європейські виробники обмежують дані у безкоштовних базах. Розблокуйте повну історію.", unBtn: "РОЗБЛОКУВАТИ НА CARVERTICAL", s: { gen: "Загальна інформація", eng: "Двигун та трансмісія", saf: "Безпека" }, f: { make: "Марка", model: "Модель", year: "Рік", trim: "Комплектація", type: "Тип ТЗ", body: "Кузов", doors: "Двері", eng: "Двигун", hp: "К.С.", fuel: "Паливо", drive: "Привід", trans: "Трансмісія", brk: "Гальма", abs: "ABS", tpms: "Шини", cntry: "Країна" }, footer: "© 2026 VIN DECODER" },
  es: { dir: 'ltr', sub: "Informe del Vehículo", back: "Volver", privacy: "Privacidad", ad: "ANUNCIO", market: "Mercado:", base: "Base:", nhtsa: "NHTSA (EE. UU.)", wmi: "WMI (Básico)", pTitle: "Informe Completo", pDesc: "Comprueba daños y kilometraje.", pBtn: "OBTENER INFORME", lTitle: "🔒 Datos Protegidos", lDesc: "Desbloquea el historial completo.", unBtn: "DESBLOQUEAR CARVERTICAL", s: { gen: "General", eng: "Motor", saf: "Seguridad" }, f: { make: "Marca", model: "Modelo", year: "Año", trim: "Versión", type: "Tipo", body: "Carrocería", doors: "Puertas", eng: "Motor", hp: "CV", fuel: "Combustible", drive: "Tracción", trans: "Transmisión", brk: "Frenos", abs: "ABS", tpms: "TPMS", cntry: "País" }, footer: "© 2026 VIN DECODER" },
  de: { dir: 'ltr', sub: "Fahrzeugbericht", back: "Zurück", privacy: "Datenschutz", ad: "WERBUNG", market: "Markt:", base: "Datenbank:", nhtsa: "NHTSA (USA)", wmi: "WMI (Basis)", pTitle: "Vollständiger Bericht", pDesc: "Unfälle und Kilometerstand.", pBtn: "BERICHT ABRUFEN", lTitle: "🔒 Daten Geschützt", lDesc: "Historie freischalten.", unBtn: "CARVERTICAL FREISCHALTEN", s: { gen: "Allgemein", eng: "Motor", saf: "Sicherheit" }, f: { make: "Marke", model: "Modell", year: "Jahr", trim: "Ausstattung", type: "Typ", body: "Karosserie", doors: "Türen", eng: "Motor", hp: "PS", fuel: "Kraftstoff", drive: "Antrieb", trans: "Getriebe", brk: "Bremsen", abs: "ABS", tpms: "RDKS", cntry: "Land" }, footer: "© 2026 VIN DECODER" },
  zh: { dir: 'ltr', sub: "车辆报告", back: "返回", privacy: "隐私", ad: "广告", market: "市场:", base: "数据源:", nhtsa: "NHTSA (美国)", wmi: "WMI (基本)", pTitle: "完整报告", pDesc: "检查损坏和里程。", pBtn: "获取报告", lTitle: "🔒 数据受保护", lDesc: "解锁完整历史。", unBtn: "解锁 CARVERTICAL", s: { gen: "常规信息", eng: "发动机", saf: "安全" }, f: { make: "品牌", model: "型号", year: "年份", trim: "配置", type: "类型", body: "车身", doors: "车门", eng: "发动机", hp: "马力", fuel: "燃料", drive: "驱动", trans: "变速箱", brk: "刹车", abs: "ABS", tpms: "TPMS", cntry: "国家" }, footer: "© 2026 VIN DECODER" },
  ar: { dir: 'rtl', sub: "تقرير المركبة", back: "رجوع", privacy: "الخصوصية", ad: "إعلان", market: "السوق:", base: "قاعدة:", nhtsa: "NHTSA (أمريكا)", wmi: "WMI (أساسي)", pTitle: "تقرير كامل", pDesc: "تحقق من الحوادث.", pBtn: "احصل على التقرير", lTitle: "🔒 بيانات محمية", lDesc: "افتح السجل الكامل.", unBtn: "افتح CARVERTICAL", s: { gen: "عام", eng: "المحرك", saf: "أمان" }, f: { make: "الماركة", model: "الموديل", year: "السنة", trim: "الفئة", type: "النوع", body: "الهيكل", doors: "الأبواب", eng: "المحرك", hp: "قوة", fuel: "الوقود", drive: "الدفع", trans: "ناقل", brk: "الفرامل", abs: "ABS", tpms: "TPMS", cntry: "البلد" }, footer: "© 2026 VIN DECODER" }
};
...
const decodeWMI = (vin) => {
  ...
  const map = {
    ...
    'WVW':{m:'VOLKSWAGEN',c:'Germany'}, 'ZAR':{m:'ALFA ROMEO',c:'Italy'}, 'ZFA':{m:'FIAT',c:'Italy'},
    'VF3':{m:'PEUGEOT',c:'France'}, 'UU1':{m:'DACIA',c:'Romania'}, 'VSS':{m:'SEAT',c:'Spain'},
    'JHM':{m:'HONDA',c:'Japan'}, 'JT1':{m:'TOYOTA',c:'Japan'}, 'KL3':{m:'CHEVROLET',c:'Korea'},
    'KNA':{m:'KIA',c:'Korea'}, 'SJ3':{m:'NISSAN',c:'UK'}, 'SAL':{m:'LAND ROVER',c:'UK'},
    '1J8':{m:'JEEP',c:'USA'}, '1FA':{m:'FORD',c:'USA'}
  };
...
export async function getServerSideProps(ctx) {
  ...
  try {
    ...
    return { props: { data: json.Results[0] || null, vin: id.toUpperCase() } };
...
export default function VinResult({ data, vin }) {
  ...
  // ПЕРЕВІРКА ЧИ Є ДАНІ В США
  const hasFullData = data && data.Make && data.Make !== "Not Applicable" && data.Make !== "";
  const val = (v) => (!v || v === "Not Applicable" || v === "null") ? "—" : v;

  // ЗЛИТТЯ ДАНИХ ТА ФІКС AUDI 1981
  const mk = hasFullData ? data.Make : (dec.make || "Unknown");
  let yr = hasFullData ? data.ModelYear : (dec.year || "—");
  if (yr === "1981" && vin.includes('ZZZ')) yr = "2011";
  
  const cy = hasFullData && data.PlantCountry ? data.PlantCountry : dec.country;
  const md = hasFullData ? data.Model : "—";
  const eng = data?.DisplacementL ? `${data.DisplacementL}L` : '';

  // ТЕГИ ТА ПОСИЛАННЯ
  const title = `${yr !== "—" ? yr : ''} ${mk !== "Unknown" ? mk : ''} ${md !== "—" ? md : ''}`.trim() || vin;
  ...
  return (
    <div dir={t.dir} className="container">
      ...
      <div className="wrapper">
        <main className="main">
          ...
          <div className="hero">
            <div className="badges">
              <div className="badge mkt"><span>{dec.mkt.i}</span> {t.market} <b>{dec.mkt.n}</b></div>
              {/* ПРАВИЛЬНА ПЛАШКА БАЗИ ДАНИХ */}
              <div className="badge src">{t.base} <b>{hasFullData ? t.nhtsa : t.wmi}</b></div>
            </div>
            
            <h2 className="v-title">
              {yr!=="—"?yr:''} <span className="yellow">{mk}</span> {md!=="—"?md:''} {eng && <span className="eng-tag">{eng}</span>}
            </h2>
          ...
          {/* ЯКЩО ЦЄ ЄВРОПА (НЕМАЄ ПОВНИХ ДАНИХ) - ПОКАЗУЄМО CARVERTICAL */}
          {!hasFullData ? (
            <div className="europe-lock">
              <div className="lock-icon">🔒</div>
              <h3>{t.lTitle}</h3>
              <p>{t.lDesc}</p>
              <a href={cvLink} target="_blank" rel="noreferrer" className="btn-pulse">{t.unBtn}</a>
            </div>
          ) : (
            <>
              <section className="section">
        ...
        <aside className="sidebar">
          <div className="premium-card">
            <h4>{t.pTitle}</h4>
            <p>{t.pDesc}</p>
            <a href={cvLink} target="_blank" rel="noreferrer" className="btn-sm">{t.pBtn}</a>
          </div>
      ...
      <style jsx>{`
        ...
        .badges{display:flex;gap:15px;margin-bottom:20px;flex-wrap:wrap;}
        .badge{padding:8px 16px;border-radius:8px;font-size:12px;border:1px solid #333;display:flex;align-items:center;gap:8px;}
        .mkt{background:#111;color:#aaa;} .src{background:rgba(37,99,235,0.1);border-color:rgba(37,99,235,0.3);color:#60a5fa;}
        ...
        .europe-lock{background:#080808;border:1px dashed #333;padding:50px 20px;border-radius:20px;text-align:center;margin-bottom:30px;}
        .lock-icon{font-size:45px;margin-bottom:15px;}
        .btn-pulse{display:inline-block;background:#facc15;color:#000;border:none;padding:18px 40px;font-weight:900;border-radius:12px;text-transform:uppercase;text-decoration:none;margin-top:15px;animation:pulse 2s infinite;}
        .btn-sm{display:block;background:#facc15;color:#000;width:100%;padding:15px;font-weight:900;border-radius:8px;text-transform:uppercase;text-align:center;text-decoration:none;box-sizing:border-box;}
        .sidebar{width:100%;}
        ...
        @media(max-width:768px){.header{flex-direction:column;gap:20px;}.badges{flex-direction:column;align-items:flex-start;}}
      `}</style>
    </div>
  );
}
